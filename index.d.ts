...
declare interface AppReview {
  prompt: (params?: { callback?: (data: any) => void }) => void | Promise<any>;
}

declare interface AppsFlyer {
...
declare interface AutoRefresh {
  set: (params: Params) => void;
}

declare interface BackgroundLocation {
  start: (params: Params) => void;
  stop: () => void;
}

declare interface BackgroundMedia {
...
declare interface DocumentScanner {
...
declare interface FirebaseAnalytics {
  event: {
...
declare interface Kaltura {
  play: (params: Params) => void;
}

declare interface LocalPreferencesMethods {
  set: (params: Params) => void;
...
declare interface LocalPreferences {
