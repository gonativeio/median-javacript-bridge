...
const moengage = {
  notificationEnabled: function (params: any) {
    return addCommandCallback('median://moengage/notificationEnabled', params, true);
  },
  promptNotification: function (params: any) {
    return addCommandCallback('median://moengage/promptNotification', params, true);
  },
  setUniqueID: function (uniqueId: any) {
    return addCommandCallback('median://moengage/setUniqueID', { uniqueId }, true);
  },
  resetUser: function () {
  ...
  trackEvent: function (eventName: any, eventData: any) {
    return addCommandCallback('median://moengage/trackEvent', { eventName, eventData }, true);
  },
